...
import { Course, Journey, ModulesFilled } from "../../interfaces";
...
export const CoursePage = () => {
    ...
    const renderModuleContent = (moduleTitle = "") => {
        ...
        const lessons = module?.lessons.map((lesson, index) => {
            return (
                <div onClick={() => navigate(`/lesson/${journeyId}/${course.id}/${lesson.title}`)} key={index} className="flex items-center gap-4 py-4 border-b-2 last-of-type:border-b-0 pl-4 md:pl-10">
